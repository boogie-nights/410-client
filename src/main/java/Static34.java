		...
		if (Static93.anInt2182 == 0 && Static96.anInt2333 == 0 && Static44.anInt1077 == 0 && Static2.anInt34 == 0) {
			...
			try {
				...
				for (@Pc(159) int local159 = 0; local159 < 100; local159++) {
					...
					@Pc(280) int local280;
					if (local180 > 0) {
						local201 = local180 - Static97.aPacket_5.anInt2546;
						if (local165 < local201) {
							local201 = local165;
						}
						Static31.aClass25_48.method725(Static97.aPacket_5.anInt2546, local201, Static97.aPacket_5.aByteArray24);
						if (Static7.aByte1 != 0) {
							for (local218 = 0; local218 < local201; local218++) {
								Static97.aPacket_5.aByteArray24[local218 + Static97.aPacket_5.anInt2546] ^= Static7.aByte1;
							}
						}
						Static97.aPacket_5.anInt2546 += local201;
						if (Static97.aPacket_5.anInt2546 < local180) {
							break;
						}
						if (Static90.aClass2_Sub2_Sub9_1 == null) {
							Static97.aPacket_5.anInt2546 = 0;
							local218 = Static97.aPacket_5.method1708();
							local272 = Static97.aPacket_5.method1704();
							@Pc(276) int local276 = Static97.aPacket_5.method1708();
							local280 = Static97.aPacket_5.method1728();
							...
							if (Static97.aPacket_5.aByteArray24[0] == -1) {
								Static11.anInt274 = 1;
								Static97.aPacket_5.anInt2546 = 0;
							} else {
						...
						if (local201 == Static29.aClass2_Sub3_2.anInt2546) {
							if (Static90.aClass2_Sub2_Sub9_1.aLong152 == 16711935L) {
								...
								for (local272 = 0; local272 < 256; local272++) {
									...
									if (local482 != null) {
										Static42.aPacket.anInt2546 = local272 * 4 + 5;
										local280 = Static42.aPacket.method1728();
