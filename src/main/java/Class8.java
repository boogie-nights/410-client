...
public final class Class8 {
	...
	public void method210(@OriginalArg(0) long arg0) {
		...
		for (@Pc(8) int local8 = 0; local8 < local6; local8++) {
			...
			this.aPacket_1.anInt2546 = this.anIntArray65[local8];
			this.method221(local8);
			this.anIntArray64[local8] = this.aPacket_1.anInt2546;
		}
	}
	...
	public boolean method215() {
		return this.aPacket_1.anInt2546 < 0;
	}
	...
	public void method217(@OriginalArg(0) int arg0) {
		this.anIntArray64[arg0] = this.aPacket_1.anInt2546;
	}
	...
	private int method219(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 != 255) {
			...
			local12 = arg1;
			if (local78 >= 1) {
				local12 = arg1 | this.aPacket_1.method1708() << 8;
			}
			if (local78 >= 2) {
				local12 |= this.aPacket_1.method1708() << 16;
			}
			return local12;
		}
		@Pc(7) int local7 = this.aPacket_1.method1708();
		local12 = this.aPacket_1.method1724();
		if (local7 == 47) {
			this.aPacket_1.anInt2546 += local12;
			return 1;
		} else if (local7 == 81) {
	...
	public void method220() {
		this.aPacket_1.aByteArray24 = null;
	...
	private int method222(@OriginalArg(0) int arg0) {
		@Pc(7) byte local7 = this.aPacket_1.aByteArray24[this.aPacket_1.anInt2546];
		@Pc(13) int local13;
		if (local7 < 0) {
			local13 = local7 & 0xFF;
			this.anIntArray67[arg0] = local13;
			this.aPacket_1.anInt2546++;
		} else {
		...
		if (local13 == 247 && local42 > 0) {
			@Pc(57) int local57 = this.aPacket_1.aByteArray24[this.aPacket_1.anInt2546] & 0xFF;
		...
		this.aPacket_1.anInt2546 += local42;
		return 0;
	}

	@OriginalMember(owner = "client!bc", name = "a", descriptor = "([B)V")
	public void method223(@OriginalArg(0) byte[] arg0) {
		this.aPacket_1.aByteArray24 = arg0;
		this.aPacket_1.anInt2546 = 10;
		@Pc(12) int local12 = this.aPacket_1.method1704();
		this.anInt250 = this.aPacket_1.method1704();
		this.anInt251 = 500000;
		this.anIntArray65 = new int[local12];
		@Pc(27) int local27 = 0;
		while (local27 < local12) {
			@Pc(33) int local33 = this.aPacket_1.method1728();
			@Pc(38) int local38 = this.aPacket_1.method1728();
			if (local33 == 1297379947) {
				this.anIntArray65[local27] = this.aPacket_1.anInt2546;
				local27++;
			}
			this.aPacket_1.anInt2546 += local38;
		}
