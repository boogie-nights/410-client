...
public final class Static59 {
	...
	public static void method997(@OriginalArg(0) Class5 arg0, @OriginalArg(2) Component comp) {
		...
		Static26.clear();
		Static17.imageMapBack.draw(0, 0);
		Static7.areaSidebar = Static83.create(comp, 190, 261);
		Static15.aClass2_Sub2_Sub2_Sub3_19.draw(0, 0);
		...
		@Pc(110) Pix24 local110 = Static103.method1644(Static105.aClass40_725, Static16.aClass40_110, arg0);
		Static41.aClass45_20 = Static83.create(comp, local110.width, local110.height);
		local110.blitOpaque(0, 0);
		@Pc(128) Pix24 local128 = Static103.method1644(Static107.aClass40_718, Static16.aClass40_110, arg0);
		Static30.aClass45_15 = Static83.create(comp, local128.width, local128.height);
		local128.blitOpaque(0, 0);
		@Pc(148) Pix24 local148 = Static103.method1644(Static46.aClass40_707, Static16.aClass40_110, arg0);
		Static80.aClass45_28 = Static83.create(comp, local148.width, local148.height);
		local148.blitOpaque(0, 0);
		@Pc(166) Pix24 local166 = Static103.method1644(Static4.aClass40_29, Static16.aClass40_110, arg0);
		Static29.aClass45_13 = Static83.create(comp, local166.width, local166.height);
		local166.blitOpaque(0, 0);
		@Pc(184) Pix24 local184 = Static103.method1644(Static42.aClass40_319, Static16.aClass40_110, arg0);
		Static92.aClass45_29 = Static83.create(comp, local184.width, local184.height);
		local184.blitOpaque(0, 0);
		@Pc(204) Pix24 local204 = Static103.method1644(Static94.aClass40_632, Static16.aClass40_110, arg0);
		Static20.aClass45_10 = Static83.create(comp, local204.width, local204.height);
		local204.blitOpaque(0, 0);
		@Pc(222) Pix24 local222 = Static103.method1644(Static67.aClass40_487, Static16.aClass40_110, arg0);
		Static1.aClass45_1 = Static83.create(comp, local222.width, local222.height);
		local222.blitOpaque(0, 0);
		@Pc(240) Pix24 local240 = Static103.method1644(Static37.aClass40_288, Static16.aClass40_110, arg0);
		Static44.aClass45_21 = Static83.create(comp, local240.width, local240.height);
		local240.blitOpaque(0, 0);
		@Pc(258) Pix24 local258 = Static103.method1644(Static36.aClass40_256, Static16.aClass40_110, arg0);
		Static19.aClass45_9 = Static83.create(comp, local258.width, local258.height);
		local258.blitOpaque(0, 0);
