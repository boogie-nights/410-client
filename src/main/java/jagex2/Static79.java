...
public final class Static79 {
	...
	public static void method1276(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		@Pc(40) ComType[] local40 = Static51.aClass2_Sub2_Sub13ArrayArray1[arg2];
		for (@Pc(42) int local42 = 0; local42 < local40.length; local42++) {
			...
			if (local48 != null && arg8 == local48.anInt1611) {
				...
				if (local48.anInt1613 == 8 && local66 <= arg6 && local75 <= arg0 && arg6 < local48.anInt1605 + local66 && local48.height + local75 > arg0) {
					Static84.anInt1979 = local42;
				}
				if ((local48.anInt1594 >= 0 || local48.anInt1615 != 0) && local66 <= arg6 && arg0 >= local75 && arg6 < local66 + local48.anInt1605 && local48.height + local75 > arg0) {
				...
				if (local48.anInt1613 != 0) {
					...
					if (local48.buttonType == 2 && Static24.spellSelected == 0 && arg6 >= local66 && local75 <= arg0 && local48.anInt1605 + local66 > arg6 && local75 + local48.height > arg0) {
					...
					if (local48.buttonType == 6 && !Static20.aBoolean40 && local66 <= arg6 && local75 <= arg0 && arg6 < local66 + local48.anInt1605 && arg0 < local48.height + local75) {
							...
							for (@Pc(557) int local557 = 0; local557 < local48.anInt1605; local557++) {
								...
								if (local578 <= arg6 && local569 <= arg0 && local578 + 32 > arg6 && arg0 < local569 + 32) {
									...
									if (local48.anIntArray331[local551] > 0) {
										...
										if (objSelected == 1 && local48.aBoolean128) {
										...
										} else if (Static24.spellSelected != 1 || !local48.aBoolean128) {
											@Pc(662) Class40[] local662 = local643.iops;
											...
											if (local48.aBoolean128) {
												for (local677 = 4; local677 >= 3; local677--) {
													if (local662 != null && local662[local677] != null) {
														...
														Static21.method402(Static80.method1334(new Class40[] { local662[local677], Static85.aClass40_572, local643.name}), local694, local42 + (arg2 << 16), local551, local643.anInt954);
													} else if (local677 == 4) {
														Static21.method402(Static80.method1334(new Class40[] { Static23.aClass40_158, local643.name}), 23, local42 + (arg2 << 16), local551, local643.anInt954);
													}
												}
											}
											if (local48.aBoolean130) {
												Static21.method402(Static80.method1334(new Class40[] { Static61.aClass40_449, local643.name}), 1, local42 + (arg2 << 16), local551, local643.anInt954);
											}
											if (local48.aBoolean128 && local662 != null) {
												for (local677 = 2; local677 >= 0; local677--) {
													if (local662[local677] != null) {
														...
														Static21.method402(Static80.method1334(new Class40[] { local662[local677], Static85.aClass40_572, local643.name}), local694, (arg2 << 16) + local42, local551, local643.anInt954);
													}
												}
											}
											...
											Static21.method402(Static80.method1334(new Class40[] { Static12.aClass40_81, local643.name}), 1002, local42 + (arg2 << 16), local551, local643.anInt954);
										} else if ((Static86.anInt2027 & 0x10) == 16) {
											Static21.method402(Static80.method1334(new Class40[] { Static83.aClass40_567, Static85.aClass40_572, local643.name}), 28, (arg2 << 16) + local42, local551, local643.anInt954);
										}
									}
								}
								local551++;
	...
	public static void method1277() {
		if (Static1.lowMemory && Static1.currentLevel != Static33.anInt786) {
			Static82.method1343(Static56.anInt2327, Static1.currentLevel, Static88.localPlayer.pathTileZ[0], Static88.localPlayer.pathTileX[0], Static49.anInt2262);
