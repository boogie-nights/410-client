...
public final class Static72 {
	...
	public static Class40 formatObjCount(@OriginalArg(0) int amount) {
		if (amount < 100000) {
			return Static53.method859(amount);
		} else if (amount < 10000000) {
			return Static80.method1334(new Class40[] { Static53.method859(amount / 1000), Static97.aClass40_669 });
		} else {
			return Static80.method1334(new Class40[] { Static53.method859(amount / 1000000), Static23.aClass40_160 });
		}
	}
