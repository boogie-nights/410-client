...
public final class Static13 {
	...
	public static void method255() {
		for (@Pc(18) LocTemporary local18 = (LocTemporary) Static92.spawnedLocations.peekFront(); local18 != null; local18 = (LocTemporary) Static92.spawnedLocations.prev()) {
	...
	public static void method256(@OriginalArg(1) Component arg0, @OriginalArg(2) GameShell arg1) {
		try {
			@Pc(8) Class24_Sub1 local8 = (Class24_Sub1) Class.forName("jagex2.Class24_Sub1_Sub1").getDeclaredConstructor().newInstance();
