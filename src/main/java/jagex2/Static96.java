...
public final class Static96 {
	...
	public static void method1549(@OriginalArg(1) int arg0) {
		...
		if (local12 == 1006) {
			local50 = Static2.npcs[local22];
			if (local50 != null) {
				@Pc(55) Class2_Sub2_Sub7 local55 = local50.type;
		...
		if (local12 == 8) {
			local50 = Static2.npcs[local22];
			if (local50 != null) {
				Static83.method1349(local50.pathTileZ[0], 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local50.pathTileX[0]);
				Static45.crossMode = 2;
				Static102.anInt2465 = Static90.anInt2133;
				Static62.anInt1554 = Static107.anInt2500;
				Static101.anInt2410 = 0;
				Static80.out.p1isaac(110);
				Static80.out.method1711(local22);
			}
		}
		if (local12 == 1005) {
			@Pc(161) int local161 = local22 >> 14 & 0x7FFF;
			@Pc(165) LocType local165 = Static91.method1470(local161);
		...
		if (local12 == 11) {
			local225 = Static83.method1349(local30, 0, Static88.localPlayer.pathTileX[0], 0, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 0, local26);
			if (!local225) {
				Static83.method1349(local30, 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local26);
			}
			Static101.anInt2410 = 0;
			Static45.crossMode = 2;
			Static102.anInt2465 = Static90.anInt2133;
			...
			Static80.out.method1711(Static30.anInt724);
			Static80.out.ip2(Static99.anInt96);
			Static80.out.ip2(local26 + Static87.anInt2058);
			Static80.out.method1694(Static30.anInt725 + local30);
			Static80.out.ip4(Static105.anInt2526);
			Static80.out.method1694(local22);
		}
		if (local12 == 56) {
			local50 = Static2.npcs[local22];
			if (local50 != null) {
		...
		if (local12 == 55) {
			Static80.out.p1isaac(79);
			Static80.out.method1722(local30);
			Static80.out.method1707(local22);
			Static80.out.method1694(local26);
			Static21.anInt481 = 2;
		...
		if (local12 == 15) {
			local462 = Static100.players[local22];
			if (local462 != null) {
				Static83.method1349(local462.pathTileZ[0], 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local462.pathTileX[0]);
				Static102.anInt2465 = Static90.anInt2133;
				Static101.anInt2410 = 0;
				Static45.crossMode = 2;
				Static62.anInt1554 = Static107.anInt2500;
		...
		if (local12 == 49) {
			...
			if (local529.anIntArrayArray11 != null && local529.anIntArrayArray11[0][0] == 5) {
				...
				if (local529.anIntArray333[0] != Static67.varps[local412]) {
					Static67.varps[local412] = local529.anIntArray333[0];
					Static22.updateVarp(local412);
		...
		if (local12 == 20) {
			...
			if (local412 != -1) {
				...
				for (local600 = 0; local600 < Static22.friendCount; local600++) {
					if (Static21.friendName37[local600] == local427) {
						local598 = local600;
						break;
					}
				}
				if (local598 != -1 && Static62.friendWorld[local598] > 0) {
					Static93.anInt2180 = 3;
					Static101.anInt2399 = 0;
					Static73.redrawChatback = true;
					Static74.aBoolean146 = true;
					Static61.aClass40_447 = Static61.aClass40_445;
					Static56.aLong136 = Static21.friendName37[local598];
					Static61.aClass40_453 = Static80.method1334(new Class40[] { Static1.aClass40_2, Static51.friendName[local598] });
				}
			}
		}
		if (local12 == 46) {
			Static80.out.p1isaac(64);
			Static80.out.p4(local30);
			Static80.out.method1707(local26);
			Static80.out.method1707(local22);
			Static52.anInt1171 = local30;
			Static21.anInt481 = 2;
			Static29.anInt719 = 0;
		...
		if (local12 == 40) {
			...
			if (local529.anIntArrayArray11 != null && local529.anIntArrayArray11[0][0] == 5) {
				local412 = local529.anIntArrayArray11[0][1];
				Static67.varps[local412] = 1 - Static67.varps[local412];
				Static22.updateVarp(local412);
				Static33.redrawSidebar = true;
			}
		}
		if (local12 == 4) {
			Static80.out.p1isaac(220);
		...
		if (local12 == 3) {
			...
			Static80.out.method1711(local22);
			Static80.out.method1694(local26 + Static87.anInt2058);
		}
		if (local12 == 16) {
			local225 = Static83.method1349(local30, 0, Static88.localPlayer.pathTileX[0], 0, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 0, local26);
			if (!local225) {
			...
			Static102.anInt2465 = Static90.anInt2133;
			Static101.anInt2410 = 0;
			Static80.out.p1isaac(200);
			Static80.out.method1694(Static30.anInt725 + local30);
			Static80.out.method1694(Static87.anInt2058 + local26);
			Static80.out.ip2(local22);
		}
		...
		if (local12 == 41) {
			...
			Static80.out.p1isaac(165);
			Static80.out.method1707(local30 + Static30.anInt725);
			Static80.out.method1711(Static87.anInt2058 + local26);
			Static80.out.ip2(local22 >> 14 & 0x7FFF);
		}
		@Pc(1295) NpcEntity local1295;
		if (local12 == 17) {
			local1295 = Static2.npcs[local22];
			if (local1295 != null) {
				Static83.method1349(local1295.pathTileZ[0], 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local1295.pathTileX[0]);
				Static102.anInt2465 = Static90.anInt2133;
				Static62.anInt1554 = Static107.anInt2500;
				Static45.crossMode = 2;
				Static101.anInt2410 = 0;
		...
		if (local12 == 1) {
			...
			Static87.aClass40_601 = Static105.get(local22).name;
		...
		if (local12 == 39) {
			Static80.out.p1isaac(135);
			Static80.out.method1707(local22);
			Static80.out.method1722(local30);
			Static80.out.method1711(local26);
			Static21.anInt481 = 2;
			Static29.anInt719 = 0;
			if (local30 >> 16 == Static22.anInt2585) {
				Static21.anInt481 = 1;
		...
		if (local12 == 14) {
			local1208 = Static83.method1349(local30, 0, Static88.localPlayer.pathTileX[0], 0, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 0, local26);
			if (!local1208) {
				Static83.method1349(local30, 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local26);
			}
			Static45.crossMode = 2;
			...
			Static62.anInt1554 = Static107.anInt2500;
			Static101.anInt2410 = 0;
			Static80.out.p1isaac(219);
			Static80.out.ip2(Static87.anInt2058 + local26);
			Static80.out.ip2(local22);
			Static80.out.ip2(local30 + Static30.anInt725);
		}
		@Pc(1556) ObjType local1556;
		if (local12 == 1001) {
			local1556 = Static105.get(local22);
			if (local1556.desc == null) {
				local70 = Static80.method1334(new Class40[] { Static42.aClass40_318, local1556.name, Static41.aClass40_306 });
			} else {
				local70 = local1556.desc;
			}
			Static58.method989(0, Static61.aClass40_445, local70);
		}
		if (local12 == 28) {
			Static80.out.p1isaac(66);
			Static80.out.method1711(local26);
			Static80.out.method1722(local30);
			Static80.out.method1694(local22);
			Static80.out.p4(Static85.anInt1992);
		...
		if (local12 == 53) {
			Static80.out.p1isaac(193);
			Static80.out.method1686(local30);
			Static80.out.ip2(local26);
			Static80.out.method1711(local22);
			Static82.anInt1947 = local26;
			Static21.anInt481 = 2;
			if (Static22.anInt2585 == local30 >> 16) {
		...
		if (local12 == 34) {
			Static42.method770(local30, local22, local26);
			Static80.out.p1isaac(222);
			Static80.out.ip2(Static30.anInt725 + local30);
			Static80.out.method1707(local22 >> 14 & 0x7FFF);
			Static80.out.method1711(Static87.anInt2058 + local26);
		}
		if (local12 == 47) {
			Static80.out.p1isaac(192);
			Static80.out.ip4(local30);
			Static80.out.method1711(local26);
			Static80.out.method1707(local22);
			Static52.anInt1171 = local30;
			Static29.anInt719 = 0;
		...
		if (local12 == 1002) {
			...
			if (local1908 != null && local1908.invSlotObjCount[local26] >= 100000) {
				local70 = Static80.method1334(new Class40[] { Static53.method859(local1908.invSlotObjCount[local26]), Static70.aClass40_496, local1556.name});
		...
		if (local12 == 1004) {
			Static42.method770(local30, local22, local26);
			Static80.out.p1isaac(33);
			Static80.out.method1707(local30 + Static30.anInt725);
			Static80.out.method1711(Static87.anInt2058 + local26);
			Static80.out.method1711(local22 >> 14 & 0x7FFF);
		}
		if (local12 == 10) {
			Static42.method770(local30, local22, local26);
			Static80.out.p1isaac(3);
			Static80.out.method1694(Static87.anInt2058 + local26);
			Static80.out.method1707(Static30.anInt725 + local30);
			Static80.out.ip2(local22 >> 14 & 0x7FFF);
		}
		if (local12 == 23) {
			Static80.out.p1isaac(29);
			Static80.out.ip2(local26);
			Static80.out.method1694(local22);
			Static80.out.ip4(local30);
			Static21.anInt481 = 2;
		...
		if (local12 == 13) {
			...
			Static101.anInt2410 = 0;
			Static62.anInt1554 = Static107.anInt2500;
			Static80.out.p1isaac(156);
			Static80.out.method1711(local22);
			Static80.out.method1694(Static87.anInt2058 + local26);
			Static80.out.method1711(Static30.anInt725 + local30);
		}
		if (local12 == 6 && Static42.method770(local30, local22, local26)) {
			Static80.out.p1isaac(116);
			Static80.out.method1694(Static30.anInt725 + local30);
			Static80.out.ip2(local26 + Static87.anInt2058);
			Static80.out.ip2(local22 >> 14 & 0x7FFF);
			Static80.out.method1722(Static85.anInt1992);
		}
		if (local12 == 29 || local12 == 37) {
			...
			if (local2373 != -1) {
				...
				for (local600 = 0; local600 < Static88.playerCount; local600++) {
					@Pc(2404) PlayerEntity local2404 = Static100.players[Static73.playerIds[local600]];
					if (local2404 != null && local2404.aClass40_395 != null && local2404.aClass40_395.method1199(local2157)) {
						local2394 = true;
						Static83.method1349(local2404.pathTileZ[0], 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local2404.pathTileX[0]);
						if (local12 == 29) {
							Static80.out.p1isaac(235);
							Static80.out.method1711(Static73.playerIds[local600]);
						}
						if (local12 == 37) {
							Static80.out.p1isaac(7);
							Static80.out.method1707(Static73.playerIds[local600]);
						}
						break;
					}
				}
		...
		if (local12 == 30) {
			local2510 = Static100.players[local22];
			if (local2510 != null) {
				Static83.method1349(local2510.pathTileZ[0], 0, Static88.localPlayer.pathTileX[0], 1, 0, 2, false, 0, Static88.localPlayer.pathTileZ[0], 1, local2510.pathTileX[0]);
				Static45.crossMode = 2;
				Static102.anInt2465 = Static90.anInt2133;
				Static62.anInt1554 = Static107.anInt2500;
				Static101.anInt2410 = 0;
				Static80.out.p1isaac(36);
				Static80.out.method1707(local22);
			}
		}
		if (local12 == 9 && Static42.method770(local30, local22, local26)) {
			Static80.out.p1isaac(44);
			Static80.out.method1707(Static99.anInt96);
			Static80.out.ip2(local22 >> 14 & 0x7FFF);
			Static80.out.method1694(Static30.anInt724);
			Static80.out.method1694(local30 + Static30.anInt725);
			Static80.out.method1686(Static105.anInt2526);
			Static80.out.method1707(local26 + Static87.anInt2058);
		}
		if (local12 == 27) {
			Static80.out.p1isaac(228);
			Static80.out.method1686(local30);
			Static80.out.method1707(local26);
			Static80.out.method1694(local22);
			Static52.anInt1171 = local30;
		...
		if (local12 == 19) {
			Static80.out.p1isaac(142);
			Static80.out.method1711(local26);
			Static80.out.method1711(Static99.anInt96);
			Static80.out.method1711(local22);
			Static80.out.method1707(Static30.anInt724);
			Static80.out.method1686(local30);
			Static80.out.method1686(Static105.anInt2526);
			Static52.anInt1171 = local30;
			Static21.anInt481 = 2;
		...
		if (local12 == 48) {
			...
			Static80.out.method1707(Static87.anInt2058 + local26);
			Static80.out.method1722(Static85.anInt1992);
			Static80.out.method1694(local22);
			Static80.out.ip2(local30 + Static30.anInt725);
		}
		...
		if (local12 == 7) {
			...
			if (local1295 != null) {
				...
				Static80.out.method1694(local22);
				Static80.out.method1694(Static30.anInt724);
				Static80.out.p4(Static105.anInt2526);
				Static80.out.ip2(Static99.anInt96);
			}
		}
		if (local12 == 43) {
			...
			if (local2510 != null) {
				...
				Static62.anInt1554 = Static107.anInt2500;
				Static101.anInt2410 = 0;
				Static80.out.p1isaac(190);
				Static80.out.method1707(local22);
			}
		}
		if (local12 == 5) {
			Static42.method770(local30, local22, local26);
			Static80.out.p1isaac(139);
			Static80.out.ip2(local30 + Static30.anInt725);
			Static80.out.method1707(local26 + Static87.anInt2058);
			Static80.out.method1711(local22 >> 14 & 0x7FFF);
		}
	...
	public static void method1553(@OriginalArg(1) PathingEntity arg0) {
		...
		if (arg0.primarySeqId != -1 && arg0.anInt2313 <= 1) {
			local15 = Static62.method1042(arg0.primarySeqId);
			if (local15.anInt663 == 1 && arg0.anInt2281 > 0 && arg0.anInt2277 <= Static107.loopCycle && arg0.anInt2297 < Static107.loopCycle) {
				arg0.anInt2313 = 1;
				return;
			}
		}
		if (arg0.primarySeqId != -1 && arg0.anInt2313 == 0) {
			local15 = Static62.method1042(arg0.primarySeqId);
			arg0.anInt2267++;
