...
public final class Static34 {
	...
	public static int method624(@OriginalArg(0) Class40 arg0, @OriginalArg(2) Packet arg1) {
		@Pc(11) int local11 = arg1.pos;
		arg1.method1695(arg0.anInt1783);
		arg1.pos += Static97.aClass42_1.method1213(arg0.aByteArray14, arg0.anInt1783, arg1.data, 0, arg1.pos);
		...
		if (Static93.anInt2182 == 0 && Static96.anInt2333 == 0 && Static44.anInt1077 == 0 && Static2.anInt34 == 0) {
			...
			try {
				...
				for (@Pc(159) int local159 = 0; local159 < 100; local159++) {
					...
					@Pc(280) int local280;
					if (local180 > 0) {
						local201 = local180 - Static97.aPacket_5.pos;
						...
						Static97.aPacket_5.pos += local201;
						if (Static97.aPacket_5.pos < local180) {
							break;
						}
						if (Static90.aClass2_Sub2_Sub9_1 == null) {
							Static97.aPacket_5.pos = 0;
							local218 = Static97.aPacket_5.g1();
							local272 = Static97.aPacket_5.g2();
							...
							Static29.aClass2_Sub3_2 = new Packet(Static90.aClass2_Sub2_Sub9_1.aByte2 + local322 + local280);
							Static29.aClass2_Sub3_2.p1(local276);
							Static29.aClass2_Sub3_2.p4(local280);
							Static97.aPacket_5.pos = 0;
							Static11.anInt274 = 8;
						} else if (Static11.anInt274 == 0) {
							if (Static97.aPacket_5.data[0] == -1) {
								Static11.anInt274 = 1;
								Static97.aPacket_5.pos = 0;
							} else {
						...
						local201 = Static29.aClass2_Sub3_2.data.length - Static90.aClass2_Sub2_Sub9_1.aByte2;
						local218 = 512 - Static11.anInt274;
						if (local218 > local201 - Static29.aClass2_Sub3_2.pos) {
							local218 = local201 - Static29.aClass2_Sub3_2.pos;
						}
						...
						Static29.aClass2_Sub3_2.pos += local218;
						Static11.anInt274 += local218;
						if (local201 == Static29.aClass2_Sub3_2.pos) {
							if (Static90.aClass2_Sub2_Sub9_1.id == 16711935L) {
								...
								for (local272 = 0; local272 < 256; local272++) {
									...
									if (local482 != null) {
										Static42.aPacket.pos = local272 * 4 + 5;
										local280 = Static42.aPacket.g4();
										local482.method92(local280);
									}
								}
							} else {
								Static102.aCRC32_2.reset();
								Static102.aCRC32_2.update(Static29.aClass2_Sub3_2.data, 0, local201);
								...
								Static90.aClass2_Sub2_Sub9_1.aClass5_Sub1_9.method91(Static29.aClass2_Sub3_2.data, Static93.aBoolean166, (Static90.aClass2_Sub2_Sub9_1.id & 0xFF0000L) == 16711680L, (int) (Static90.aClass2_Sub2_Sub9_1.id & 0xFFFFL));
							}
