...
public final class ViewBox extends Canvas implements WindowListener {
	...
	public ViewBox(@OriginalArg(0) Applet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anApplet2 = arg0;
