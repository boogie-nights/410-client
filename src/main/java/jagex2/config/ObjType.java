...
public final class ObjType extends Hashable {
	...
	public Model method713(@OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1) {
		...
		if (this.anInt957 != 128 || this.anInt959 != 128 || this.anInt920 != 128) {
			model.scale(this.anInt957, this.anInt959, this.anInt920);
		}
		if (this.recol_s != null) {
			for (local15 = 0; local15 < this.recol_s.length; local15++) {
				model.recolor(this.recol_s[local15], this.recol_d[local15]);
			}
		}
		if (arg1) {
	...
	public Model method714(@OriginalArg(0) boolean arg0) {
		...
		if (this.recol_s != null) {
			for (@Pc(67) int local67 = 0; local67 < this.recol_s.length; local67++) {
				local37.recolor(this.recol_s[local67], this.recol_d[local67]);
			}
		}
		return local37;
	}
	...
	public Model method718(@OriginalArg(1) boolean arg0) {
		...
		if (!arg0 && this.manwearOffsetY != 0) {
			local36.translate(0, this.manwearOffsetY, 0);
		}
		if (arg0 && this.womanwearOffsetY != 0) {
			local36.translate(0, this.womanwearOffsetY, 0);
		}
		if (this.recol_s != null) {
			for (@Pc(126) int local126 = 0; local126 < this.recol_s.length; local126++) {
				local36.recolor(this.recol_s[local126], this.recol_d[local126]);
			}
		}
		return local36;
	}
	...
	private void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet dat) {
		if (code == 1) {
			...
			this.anInt957 = dat.g2();
		} else if (code == 111) {
			this.anInt959 = dat.g2();
		} else if (code == 112) {
			this.anInt920 = dat.g2();
		} else if (code == 113) {
			this.anInt942 = dat.g1b();
		} else if (code == 114) {
			this.anInt940 = dat.g1b() * 5;
		} else if (code == 115) {
			this.anInt951 = dat.g1();
		}
	}
