...
public final class Model extends Class2_Sub2_Sub12 {
	...
	public Model(@OriginalArg(0) byte[] arg0) {
		...
		for (@Pc(321) int local321 = 0; local321 < local51; local321++) {
			...
			local328 = 0;
			if ((local326 & 0x1) != 0) {
				local328 = local26.gsmart();
			}
			local338 = 0;
			if ((local326 & 0x2) != 0) {
				local338 = local31.gsmart();
			}
			local348 = 0;
			if ((local326 & 0x4) != 0) {
				local348 = local36.gsmart();
			}
			...
			if (this.vertexLabel != null) {
				this.vertexLabel[local321] = local41.g1();
			}
		}
		...
		for (local326 = 0; local326 < local55; local326++) {
			this.faceColor[local326] = local21.g2();
			if (this.faceInfo != null) {
				this.faceInfo[local326] = local26.g1();
			}
			if (this.facePriority != null) {
				this.facePriority[local326] = local31.g1();
			}
			if (this.faceAlpha != null) {
				this.faceAlpha[local326] = local36.g1();
			}
			if (this.faceLabel != null) {
				this.faceLabel[local326] = local41.g1();
			}
		}
		...
		for (@Pc(491) int local491 = 0; local491 < local55; local491++) {
			local496 = local26.g1();
			if (local496 == 1) {
				local328 = local21.gsmart() + local489;
				local338 = local21.gsmart() + local328;
				local348 = local21.gsmart() + local338;
				local489 = local348;
			...
			if (local496 == 2) {
				local338 = local348;
				local348 = local21.gsmart() + local489;
				local489 = local348;
				this.faceVertexA[local491] = local328;
				this.faceVertexB[local491] = local338;
				this.faceVertexC[local491] = local348;
		...
		for (local496 = 0; local496 < local59; local496++) {
			this.texturedVertexA[local496] = local21.g2();
			this.texturedVertexB[local496] = local21.g2();
			this.texturedVertexC[local496] = local21.g2();
		}
	}
	...
	public void rotateY180() {
		this.vertexNormal = null;
		this.anInt1740 = 0;
		for (@Pc(7) int v = 0; v < this.vertexCount; v++) {
			this.vertexZ[v] = -this.vertexZ[v];
		}
		for (@Pc(24) int f = 0; f < this.faceCount; f++) {
			@Pc(30) int temp = this.faceVertexA[f];
	...
	public void translate(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int z) {
		this.anInt1740 = 0;
		for (@Pc(4) int v = 0; v < this.vertexCount; v++) {
			this.vertexX[v] += x;
			this.vertexY[v] += y;
			this.vertexZ[v] += z;
		}
	...
	private void draw(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
			...
			if (this.faceInfo == null || this.faceInfo[local18] != -1) {
				...
				if (arg0 && (local47 == -5000 || local51 == -5000 || local55 == -5000)) {
					...
					if (local74 * local134 + local86 * local142 + local98 * local150 > 0) {
						...
						Static71.tmpDepthFaces[local183][Static71.anIntArray391[local183]++] = local18;
					}
				} else {
					...
					if ((local47 - local51) * (Static71.vertexScreenX[local43] - Static71.vertexScreenX[local38]) - (Static71.vertexScreenX[local33] - Static71.vertexScreenX[local38]) * (local55 - local51) > 0) {
						...
						Static71.tmpDepthFaces[local70][Static71.anIntArray391[local70]++] = local18;
					}
				}
			}
		}
		if (this.facePriority == null) {
			for (local33 = this.maxX - 1; local33 >= 0; local33--) {
				...
				if (local38 > 0) {
					@Pc(332) int[] local332 = Static71.tmpDepthFaces[local33];
		...
		for (local38 = this.maxX - 1; local38 >= 0; local38--) {
			...
			if (local43 > 0) {
				@Pc(379) int[] local379 = Static71.tmpDepthFaces[local38];
				for (local51 = 0; local51 < local43; local51++) {
					...
					Static71.tmpPriorityFaces[local70][local74] = local55;
					if (local70 < 10) {
		...
		@Pc(524) int[] local524 = Static71.tmpPriorityFaces[10];
		@Pc(526) int[] local526 = Static71.anIntArray394;
		if (local74 == 0) {
			local70 = 0;
			local74 = Static71.anIntArray385[11];
			local524 = Static71.tmpPriorityFaces[11];
		...
		for (local86 = 0; local86 < 10; local86++) {
			while (local86 == 0 && local55 > local43) {
				...
				if (local70 == local74 && local524 != Static71.tmpPriorityFaces[11]) {
					local70 = 0;
					local74 = Static71.anIntArray385[11];
					local524 = Static71.tmpPriorityFaces[11];
					local526 = Static71.anIntArray403;
			...
			@Pc(689) int[] local689 = Static71.tmpPriorityFaces[local86];
	...
	public void recolor(@OriginalArg(0) int src, @OriginalArg(1) int dest) {
		for (@Pc(1) int f = 0; f < this.faceCount; f++) {
			if (this.faceColor[f] == src) {
				this.faceColor[f] = dest;
			}
		}
	}
	...
	private void method1143() {
		...
		this.anInt1740 = 2;
		this.minX = 0;
		for (@Pc(12) int v = 0; v < this.vertexCount; v++) {
			@Pc(18) int local18 = this.vertexX[v];
			@Pc(23) int local23 = this.vertexY[v];
			@Pc(28) int local28 = this.vertexZ[v];
	...
	public void rotateX(@OriginalArg(0) int angle) {
		this.vertexNormal = null;
		this.anInt1740 = 0;
		@Pc(9) int sin = Static71.sin[angle];
		@Pc(13) int cos = Static71.cos[angle];
		for (@Pc(15) int v = 0; v < this.vertexCount; v++) {
			@Pc(32) int tmp = this.vertexY[v] * cos - this.vertexZ[v] * sin >> 16;
	...
	private int addVertex(@OriginalArg(0) Model src, @OriginalArg(1) int vertexId) {
		@Pc(1) int identical = -1;
		@Pc(6) int x = src.vertexX[vertexId];
		@Pc(11) int y = src.vertexY[vertexId];
		@Pc(16) int z = src.vertexZ[vertexId];
		for (@Pc(18) int v = 0; v < this.vertexCount; v++) {
	...
	public void calculateNormals(@OriginalArg(0) int lightAmbient, @OriginalArg(1) int lightAttenuation, @OriginalArg(2) int lightSrcX, @OriginalArg(3) int lightSrcY, @OriginalArg(4) int lightSrcZ, @OriginalArg(5) boolean applyLighting) {
		...
		for (int f = 0; f < this.faceCount; f++) {
			...
			if (this.faceInfo == null || (this.faceInfo[f] & 0x1) == 0) {
				...
				this.faceColorA[f] = Static71.mulColorLightness(this.faceColor[f], lightness, this.faceInfo[f]);
			}
		}
		if (applyLighting) {
	...
	public void scale(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int z) {
		this.vertexNormal = null;
		this.anInt1740 = 0;
		for (@Pc(7) int v = 0; v < this.vertexCount; v++) {
			this.vertexX[v] = this.vertexX[v] * x / 128;
	...
	public void method1159(@OriginalArg(0) Class2_Sub2_Sub14 arg0, @OriginalArg(1) int primaryId, @OriginalArg(2) Class2_Sub2_Sub14 arg2, @OriginalArg(3) int secondaryId, @OriginalArg(4) int[] mask) {
		if (primaryId == -1) {
			return;
		}
		if (mask == null || secondaryId == -1) {
			this.method1134(arg0, primaryId);
			return;
		}

		this.vertexNormal = null;
		this.anInt1740 = 0;
		@Pc(24) Class28 primary = arg0.aClass28Array1[primaryId];
		@Pc(29) Class28 secondary = arg2.aClass28Array1[secondaryId];
		@Pc(32) Class2_Sub5 skelton = primary.aClass2_Sub5_1;
		...
		@Pc(45) int local45 = mask[0];
		@Pc(53) int local53;

		for (@Pc(47) int local47 = 0; local47 < primary.anInt1098; local47++) {
			local53 = primary.anIntArray226[local47];
			while (local53 > local45) {
				local45 = mask[local43++];
			}
			if (local53 != local45 || skelton.anIntArray142[local53] == 0) {
				this.applyTransform(skelton.anIntArray142[local53], skelton.anIntArrayArray10[local53], primary.anIntArray231[local47], primary.anIntArray230[local47], primary.anIntArray229[local47]);
			}
		}
		Static71.baseX = 0;
		Static71.baseY = 0;
		...
		local43 = local40 + 1;
		local45 = mask[0];
		for (local53 = 0; local53 < secondary.anInt1098; local53++) {
			@Pc(118) int local118 = secondary.anIntArray226[local53];
			while (local118 > local45) {
				local45 = mask[local43++];
			}
			if (local118 == local45 || skelton.anIntArray142[local118] == 0) {
				this.applyTransform(skelton.anIntArray142[local118], skelton.anIntArrayArray10[local118], secondary.anIntArray231[local53], secondary.anIntArray230[local53], secondary.anIntArray229[local53]);
			}
		}
	}
	...
	private void applyLighting(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(1) int local1 = 0; local1 < this.faceCount; local1++) {
			...
			if (this.faceInfo == null) {
				...
				this.faceColorA[local1] = Static71.mulColorLightness(local25, local52, 0);
				...
				this.faceColorB[local1] = Static71.mulColorLightness(local25, local87, 0);
				...
				this.faceColorC[local1] = Static71.mulColorLightness(local25, local122, 0);
			} else if ((this.faceInfo[local1] & 0x1) == 0) {
				local25 = this.faceColor[local1];
				@Pc(148) int local148 = this.faceInfo[local1];
				local30 = this.vertexNormal[local7];
				local52 = arg0 + (arg2 * local30.x + arg3 * local30.y + arg4 * local30.z) / (arg1 * local30.w);
				this.faceColorA[local1] = Static71.mulColorLightness(local25, local52, local148);
				local30 = this.vertexNormal[local12];
				local52 = arg0 + (arg2 * local30.x + arg3 * local30.y + arg4 * local30.z) / (arg1 * local30.w);
				this.faceColorB[local1] = Static71.mulColorLightness(local25, local52, local148);
				local30 = this.vertexNormal[local17];
				local52 = arg0 + (arg2 * local30.x + arg3 * local30.y + arg4 * local30.z) / (arg1 * local30.w);
				this.faceColorC[local1] = Static71.mulColorLightness(local25, local52, local148);
			}
		}
		this.vertexNormal = null;
