...
public final class Static24 {
	...
	public static Js5ResourceProvider aClass5_Sub1_4;
	...
	public static void method520() {
		while (true) {
			if (Static1.aClass2_Sub3_Sub1_5.method1742(Static1.anInt785) >= 26) {
				@Pc(17) int local17 = Static1.aClass2_Sub3_Sub1_5.method1743(14);
				if (local17 != 16383) {
					...
					@Pc(50) int local50 = Static1.aClass2_Sub3_Sub1_5.method1743(5);
					if (local50 > 15) {
						local50 -= 32;
					}
					@Pc(61) int local61 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
					local34.aClass2_Sub2_Sub7_1 = Static34.method640(Static1.aClass2_Sub3_Sub1_5.method1743(13));
					@Pc(78) int local78 = Static1.aClass2_Sub3_Sub1_5.method1743(5);
					@Pc(85) int local85 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
					if (local85 == 1) {
