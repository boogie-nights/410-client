...
public final class Static90 {
	...
	public static void method1567() {
		while (true) {
			if (Static1.aClass2_Sub3_Sub1_5.method1742(Static1.anInt785) >= 11) {
				@Pc(14) int local14 = Static1.aClass2_Sub3_Sub1_5.method1743(11);
				if (local14 != 2047) {
					...
					@Pc(59) int local59 = Static1.aClass2_Sub3_Sub1_5.method1743(5);
					if (local59 > 15) {
						local59 -= 32;
					}
					@Pc(68) int local68 = Static1.aClass2_Sub3_Sub1_5.method1743(5);
					if (local68 > 15) {
						local68 -= 32;
					}
					@Pc(79) int local79 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
					if (local79 == 1) {
						Static1.anIntArray504[Static1.anInt1190++] = local14;
					}
					@Pc(97) int local97 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
