...
public abstract class MidiAudioBuss extends AudioBuss {
	...
	protected final boolean method1253(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) long arg3) {
		if ((arg0 & 0xF0) == 176) {
			...
			if (arg1 == 121) {
				...
				local17 = arg0 & 0xF;
				Static1.anIntArray257[local17] = 12800;
			...
			if (arg1 == 7 || arg1 == 39) {
				local17 = arg0 & 0xF;
				if (arg1 == 7) {
					Static1.anIntArray257[local17] = (Static1.anIntArray257[local17] & 0x7F) + (arg2 << 7);
				} else {
					Static1.anIntArray257[local17] = (Static1.anIntArray257[local17] & 0x3F80) + arg2;
				}
				local24 = Static14.method1258(local17);
				this.method1262(arg0, 7, local24 >> 7, arg3);
				this.method1262(arg0, 39, local24 & 0x7F, arg3);
	...
	protected final void method1256(@OriginalArg(1) int arg0, @OriginalArg(2) long arg1, @OriginalArg(3) int arg2) {
		...
		if (local14 == Static1.anInt2179) {
			return;
		}
		Static1.anInt2179 = local14;
