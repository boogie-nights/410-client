...
public final class Static95 {
	...
	public static void method1646(@OriginalArg(1) Pix24 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(32) int local32 = Static1.anInt1978 + client.orbitCameraYaw & 0x7FF;
	...
	public static void method1647() {
		...
		if (Static1.anInt1850 == 0) {
			client.scene = new World3D(4, 104, 104, World.levelHeightmap);
			for (local17 = 0; local17 < 4; local17++) {
				client.levelCollisionMap[local17] = new CollisionMap(104, 104);
			}
		...
		if (Static1.anInt1850 == 30) {
			...
			if (Static70.aClass2_Sub2_Sub2_Sub2_4 == null) {
				Static70.aClass2_Sub2_Sub2_Sub2_4 = Static50.method941(Static74.spritesJs5, JagString.EMPTY_STRING, JagString.aClass40_620);
			} else {
				local17++;
			}
			...
			if (Static39.aClass2_Sub2_Sub2_Sub2_2 == null) {
				Static39.aClass2_Sub2_Sub2_Sub2_2 = Static50.method941(Static74.spritesJs5, JagString.EMPTY_STRING, JagString.aClass40_543);
			} else {
				local17++;
			}
			if (local17 < 4) {
			...
			if (Static12.aClass2_Sub2_Sub2_Sub4_2 == null) {
				Static12.aClass2_Sub2_Sub2_Sub4_2 = method1644(JagString.aClass40_307, JagString.EMPTY_STRING, Static74.spritesJs5);
			} else {
				local17++;
			}
			if (Static96.aClass2_Sub2_Sub2_Sub4_10 == null) {
				Static96.aClass2_Sub2_Sub2_Sub4_10 = method1644(JagString.aClass40_647, JagString.EMPTY_STRING, Static74.spritesJs5);
			} else {
				local17++;
			}
			if (Static51.aClass2_Sub2_Sub2_Sub3Array15 == null) {
				Static51.aClass2_Sub2_Sub2_Sub3Array15 = Static4.method85(Static74.spritesJs5, JagString.aClass40_520, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static91.aClass2_Sub2_Sub2_Sub4Array2 == null) {
				Static91.aClass2_Sub2_Sub2_Sub4Array2 = Static34.method638(Static74.spritesJs5, JagString.aClass40_663, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static27.aClass2_Sub2_Sub2_Sub4Array4 == null) {
				Static27.aClass2_Sub2_Sub2_Sub4Array4 = Static34.method638(Static74.spritesJs5, JagString.aClass40_26, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static41.aClass2_Sub2_Sub2_Sub4Array6 == null) {
				Static41.aClass2_Sub2_Sub2_Sub4Array6 = Static34.method638(Static74.spritesJs5, JagString.aClass40_607, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static53.aClass2_Sub2_Sub2_Sub4Array8 == null) {
				Static53.aClass2_Sub2_Sub2_Sub4Array8 = Static34.method638(Static74.spritesJs5, JagString.aClass40_433, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			...
			if (Static12.aClass2_Sub2_Sub2_Sub4Array3 == null) {
				Static12.aClass2_Sub2_Sub2_Sub4Array3 = Static34.method638(Static74.spritesJs5, JagString.aClass40_101, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			...
			if (Static28.aClass2_Sub2_Sub2_Sub4Array5 == null) {
				Static28.aClass2_Sub2_Sub2_Sub4Array5 = Static34.method638(Static74.spritesJs5, JagString.aClass40_727, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static85.aClass2_Sub2_Sub2_Sub3Array12 == null) {
				Static85.aClass2_Sub2_Sub2_Sub3Array12 = Static4.method85(Static74.spritesJs5, JagString.aClass40_643, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (Static64.aClass2_Sub2_Sub2_Sub3Array8 == null) {
				Static64.aClass2_Sub2_Sub2_Sub3Array8 = Static4.method85(Static74.spritesJs5, JagString.aClass40_222, JagString.EMPTY_STRING);
			} else {
				local17++;
			}
			if (local17 < 14) {
			...
			if (Static33.texturesJs5.method78()) {
				@Pc(1269) Js5TextureProvider local1269 = new Js5TextureProvider(Static33.texturesJs5, Static74.spritesJs5, 20, 0.8D, client.lowMemory ? 64 : 128);
				...
				JagString.aClass40_680 = JagString.concatenate(new JagString[] { JagString.aClass40_527, Static48.method859(Static33.texturesJs5.method87()), JagString.aClass40_430 });
				Static1.anInt2194 = 90;
			}
			...
			if (Static73.binaryJs5.method73(JagString.EMPTY_STRING, JagString.aClass40_131)) {
				@Pc(1325) Huffman local1325 = new Huffman(Static73.binaryJs5.method69(JagString.aClass40_131, JagString.EMPTY_STRING));
			...
			if (Static26.interfacesJs5.method78()) {
				...
				JagString.aClass40_680 = JagString.concatenate(new JagString[] { JagString.aClass40_619, Static48.method859(Static26.interfacesJs5.method87()), JagString.aClass40_430 });
				Static1.anInt2194 = 100;
			}
