		...
		synchronized (this.aClass14_3) {
			try {
				...
				if (arg1) {
					...
					this.aClass14_2.method350(0, 6, Static1.aByteArray17);
					local27 = (Static1.aByteArray17[5] & 0xFF) + (((Static1.aByteArray17[3] & 0xFF) << 16) + ((Static1.aByteArray17[4] & 0xFF) << 8));
				...
				Static1.aByteArray17[0] = (byte) (arg0 >> 16);
				@Pc(121) int local121 = 0;
				@Pc(123) int local123 = 0;
				Static1.aByteArray17[1] = (byte) (arg0 >> 8);
				Static1.aByteArray17[2] = (byte) arg0;
				Static1.aByteArray17[3] = (byte) (local27 >> 16);
				Static1.aByteArray17[4] = (byte) (local27 >> 8);
				Static1.aByteArray17[5] = (byte) local27;
				this.aClass14_2.method346((long) (arg3 * 6));
				this.aClass14_2.method348(Static1.aByteArray17, 6, 0);
				while (local121 < arg0) {
					...
					if (arg1) {
						...
						try {
							this.aClass14_3.method350(0, 8, Static1.aByteArray17);
						} catch (@Pc(194) EOFException local194) {
							return true;
						}
						local175 = (Static1.aByteArray17[6] & 0xFF) + ((Static1.aByteArray17[4] & 0xFF) << 16) + ((Static1.aByteArray17[5] & 0xFF) << 8);
						local233 = (Static1.aByteArray17[1] & 0xFF) + ((Static1.aByteArray17[0] & 0xFF) << 8);
						@Pc(239) int local239 = Static1.aByteArray17[7] & 0xFF;
						@Pc(253) int local253 = ((Static1.aByteArray17[2] & 0xFF) << 8) + (Static1.aByteArray17[3] & 0xFF);
					...
					Static1.aByteArray17[0] = (byte) (arg3 >> 8);
					Static1.aByteArray17[1] = (byte) arg3;
					Static1.aByteArray17[2] = (byte) (local123 >> 8);
					Static1.aByteArray17[3] = (byte) local123;
					local123++;
					if (arg0 - local121 <= 512) {
						local175 = 0;
					}
					local233 = arg0 - local121;
					Static1.aByteArray17[4] = (byte) (local175 >> 16);
					Static1.aByteArray17[5] = (byte) (local175 >> 8);
					if (local233 > 512) {
						local233 = 512;
					}
					Static1.aByteArray17[6] = (byte) local175;
					Static1.aByteArray17[7] = (byte) this.anInt297;
					this.aClass14_3.method346((long) (local27 * 520));
					local27 = local175;
					this.aClass14_3.method348(Static1.aByteArray17, 8, 0);
	...
	public byte[] read(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass14_3) {
			try {
				...
				this.aClass14_2.method350(0, 6, Static1.aByteArray17);
				@Pc(72) int local72 = ((Static1.aByteArray17[0] & 0xFF) << 16) - (-((Static1.aByteArray17[1] & 0xFF) << 8) - (Static1.aByteArray17[2] & 0xFF));
				@Pc(94) int local94 = ((Static1.aByteArray17[4] & 0xFF) << 8) + (Static1.aByteArray17[3] << 16 & 0xFF0000) + (Static1.aByteArray17[5] & 0xFF);
				if (local72 < 0 || local72 > this.anInt301) {
					...
					label55: while (local72 > local139) {
						...
						this.aClass14_3.method350(0, local153 + 8, Static1.aByteArray17);
						@Pc(200) int local200 = (Static1.aByteArray17[6] & 0xFF) + ((Static1.aByteArray17[4] & 0xFF) << 16) + ((Static1.aByteArray17[5] & 0xFF) << 8);
						@Pc(214) int local214 = (Static1.aByteArray17[3] & 0xFF) + ((Static1.aByteArray17[2] & 0xFF) << 8);
						@Pc(220) int local220 = Static1.aByteArray17[7] & 0xFF;
						@Pc(235) int local235 = ((Static1.aByteArray17[0] & 0xFF) << 8) + (Static1.aByteArray17[1] & 0xFF);
						if (arg0 == local235 && local137 == local214 && this.anInt297 == local220) {
							if (local200 >= 0 && this.aClass14_3.method351() / 520L >= (long) local200) {
								...
								while (true) {
									...
									local135[local139++] = Static1.aByteArray17[local286 + 8];
									local286++;
								}
							}
							return null;
