...
public final class MidiDecoder {
	...
	public void method210(@OriginalArg(0) long arg0) {
		...
		for (@Pc(8) int local8 = 0; local8 < local6; local8++) {
			...
			this.aClass2_Sub3_1.pos = this.anIntArray65[local8];
			this.method221(local8);
			this.anIntArray64[local8] = this.aClass2_Sub3_1.pos;
		}
	}
	...
	public boolean method215() {
		return this.aClass2_Sub3_1.pos < 0;
	}
	...
	public void method217(@OriginalArg(0) int arg0) {
		this.anIntArray64[arg0] = this.aClass2_Sub3_1.pos;
	}
	...
	private int method219(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12;
		if (arg1 != 255) {
			@Pc(78) byte local78 = Static1.aByteArray2[arg1 - 128];
			local12 = arg1;
			if (local78 >= 1) {
				local12 = arg1 | this.aClass2_Sub3_1.g1() << 8;
			}
			if (local78 >= 2) {
				local12 |= this.aClass2_Sub3_1.g1() << 16;
			}
			return local12;
		}
		@Pc(7) int local7 = this.aClass2_Sub3_1.g1();
		local12 = this.aClass2_Sub3_1.gVarInt();
		if (local7 == 47) {
			this.aClass2_Sub3_1.pos += local12;
			return 1;
		} else if (local7 == 81) {
			@Pc(32) int local32 = this.aClass2_Sub3_1.g3();
			local12 -= 3;
	...
	public void method221(@OriginalArg(0) int arg0) {
		@Pc(4) int local4 = this.aClass2_Sub3_1.gVarInt();
	...
	private int method222(@OriginalArg(0) int arg0) {
		@Pc(7) byte local7 = this.aClass2_Sub3_1.data[this.aClass2_Sub3_1.pos];
		@Pc(13) int local13;
		if (local7 < 0) {
			local13 = local7 & 0xFF;
			this.anIntArray67[arg0] = local13;
			this.aClass2_Sub3_1.pos++;
		} else {
		...
		@Pc(42) int local42 = this.aClass2_Sub3_1.gVarInt();
		if (local13 == 247 && local42 > 0) {
			@Pc(57) int local57 = this.aClass2_Sub3_1.data[this.aClass2_Sub3_1.pos] & 0xFF;
		...
		this.aClass2_Sub3_1.pos += local42;
		return 0;
	}

	@OriginalMember(owner = "client!bc", name = "a", descriptor = "([B)V", line = 186)
	public void method223(@OriginalArg(0) byte[] arg0) {
		this.aClass2_Sub3_1.data = arg0;
		this.aClass2_Sub3_1.pos = 10;
		@Pc(12) int local12 = this.aClass2_Sub3_1.g2();
		this.anInt250 = this.aClass2_Sub3_1.g2();
		this.anInt251 = 500000;
		this.anIntArray65 = new int[local12];
		@Pc(27) int local27 = 0;
		while (local27 < local12) {
			@Pc(33) int local33 = this.aClass2_Sub3_1.g4s();
			@Pc(38) int local38 = this.aClass2_Sub3_1.g4s();
			if (local33 == 1297379947) {
				this.anIntArray65[local27] = this.aClass2_Sub3_1.pos;
				local27++;
			}
			this.aClass2_Sub3_1.pos += local38;
		}
