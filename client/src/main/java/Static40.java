		...
		try {
			...
			if (Static1.anInt693 == 4) {
				if (Static1.in.pos < 8) {
					...
					if (local108 > 8 - Static1.in.pos) {
						local108 = 8 - Static1.in.pos;
					}
					if (local108 > 0) {
						Static64.aClass25_36.method725(Static1.in.pos, local108, Static1.in.data);
						Static1.in.pos += local108;
					}
				}
				if (Static1.in.pos == 8) {
					Static1.in.pos = 0;
					Static1.aLong139 = Static1.in.g8();
					Static1.anInt693 = 5;
				}
			}
