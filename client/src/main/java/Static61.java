...
public final class Static61 {
	...
	public static void method1095(@OriginalArg(0) boolean arg0, @OriginalArg(1) JagString arg1, @OriginalArg(2) JagString arg2) {
		...
		if (Static1.aBoolean1) {
			...
			Static99.method1664(Static1.anInt2515, client.graphics, client.fontPlain12, Static1.anInt2491, Static1.anInt583);
		...
		Static69.method1230();
		client.fontPlain12.method566(arg2, 257, 148, 0);
		client.fontPlain12.method566(arg2, 256, 147, 16777215);
		if (arg1 != null) {
			local6 += 15;
			if (arg0) {
				@Pc(81) int local81 = client.fontPlain12.method568(arg1) + 4;
				Static25.method1612(257 - local81 / 2, 152, local81, 11, 0);
			}
			client.fontPlain12.method566(arg1, 257, 163, 0);
			client.fontPlain12.method566(arg1, 256, 162, 16777215);
		}
