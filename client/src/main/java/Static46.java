...
public final class Static46 {
	...
	public static void method846(@OriginalArg(0) int arg0, @OriginalArg(1) PlayerEntity arg1, @OriginalArg(2) int arg2) {
		if ((arg2 & 0x80) != 0) {
			arg1.anInt2324 = client.in.g2_alt1();
		...
		if ((arg2 & 0x40) != 0) {
			...
			client.in.gdata_alt1(local30, local27);
			Static1.aClass2_Sub3Array1[arg0] = local35;
			arg1.method918(local35);
		}
		if ((arg2 & 0x10) != 0) {
			arg1.aClass40_660 = client.in.gjstr();
		...
		if ((arg2 & 0x100) != 0) {
			arg1.anInt2317 = client.in.g1_alt3();
			arg1.anInt2321 = client.in.g1_alt1();
			arg1.anInt2311 = client.in.g1_alt3();
			arg1.anInt2286 = client.in.g1_alt3();
			arg1.anInt2277 = client.in.g2_alt1() + Static1.anInt2511;
			arg1.anInt2297 = client.in.g2_alt2() + Static1.anInt2511;
			arg1.anInt2314 = client.in.g1_alt1();
			arg1.method1543();
		}
		if ((arg2 & 0x400) != 0) {
			arg1.anInt2302 = client.in.g2_alt2();
			local27 = client.in.g4s();
			arg1.anInt2291 = 0;
		...
		if ((arg2 & 0x1) != 0) {
			local27 = client.in.g2_alt1();
			local124 = client.in.g1_alt3();
			local141 = client.in.g1_alt3();
			@Pc(332) int local332 = client.in.pos;
			if (arg1.aClass40_395 != null && arg1.aClass33_2 != null) {
				...
				if (!local340 && Static1.anInt440 == 0) {
					...
					client.in.gdata_alt1(Static1.aClass2_Sub3_4.data, local141);
					Static1.aClass2_Sub3_4.pos = 0;
			...
			client.in.pos = local332 + local141;
		}
		if ((arg2 & 0x200) != 0) {
			local27 = client.in.g1();
			local124 = client.in.g1();
			arg1.method1540(local27, Static1.anInt2511, local124);
			arg1.anInt2315 = Static1.anInt2511 + 300;
			arg1.anInt2298 = client.in.g1_alt1();
			arg1.anInt2279 = client.in.g1_alt3();
		}
		if ((arg2 & 0x20) != 0) {
			...
			arg1.anInt2315 = Static1.anInt2511 + 300;
			arg1.anInt2298 = client.in.g1_alt1();
			arg1.anInt2279 = client.in.g1_alt1();
		}
		if ((arg2 & 0x2) != 0) {
			arg1.anInt2280 = client.in.g2_alt1();
			arg1.anInt2292 = client.in.g2_alt2();
		}
	}
