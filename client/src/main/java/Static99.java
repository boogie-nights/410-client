...
public final class Static99 {
	...
	public static int method1660(@OriginalArg(0) int arg0, @OriginalArg(2) ComType arg1) {
		...
		try {
			...
			while (true) {
				...
				if (local31 == 1) {
					local33 = Static1.anIntArray473[local22[local17++]];
				}
				if (local31 == 15) {
					local35 = 1;
				}
				...
				if (local31 == 2) {
					local33 = Static1.anIntArray312[local22[local17++]];
				}
				if (local31 == 3) {
					local33 = Static1.anIntArray234[local22[local17++]];
				}
				@Pc(103) int local103;
				...
				if (local31 == 5) {
					local33 = Static1.anIntArray339[local22[local17++]];
				}
				if (local31 == 6) {
					local33 = Static1.anIntArray80[Static1.anIntArray312[local22[local17++]] - 1];
				}
				if (local31 == 7) {
				...
				if (local31 == 9) {
					for (local103 = 0; local103 < 25; local103++) {
						if (Static1.aBooleanArray27[local103]) {
							local33 += Static1.anIntArray312[local103];
						}
					}
				}
				if (local31 == 10) {
				...
				if (local31 == 11) {
					local33 = Static1.anInt2181;
				}
				if (local31 == 12) {
					local33 = Static1.anInt1813;
				}
				if (local31 == 13) {
					local103 = Static1.anIntArray339[local22[local17++]];
	...
	public static int method1662(@OriginalArg(1) int arg0) {
		...
		return local23 & Static1.anIntArray339[local13] >> local10;
	}
