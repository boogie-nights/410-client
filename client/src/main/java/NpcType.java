...
public final class NpcType extends Hashable {
	...
	public final JagString[] aClass40Array14 = new JagString[5];
	...
	public JagString aClass40_238 = JagString.aClass40_561;
	...
	public Model method605(@OriginalArg(0) SpotAnimType arg0, @OriginalArg(1) SpotAnimType arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		@Pc(37) Model local37 = (Model) Static1.aClass47_19.method1325((long) this.anInt762);
		if (local37 == null) {
			...
			Static1.aClass47_19.method1332((long) this.anInt762, local37);
		}
