...
public final class Static22 {
	...
	public static void method477() {
		...
		@Pc(13) int local13 = Static1.aClass2_Sub3_Sub1_5.method1743(8);
		...
		for (@Pc(62) int local62 = 0; local62 < local13; local62++) {
			...
			@Pc(77) int local77 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
			if (local77 == 0) {
				Static1.anIntArray326[Static1.anInt1800++] = local68;
				local72.anInt2274 = Static1.anInt2511;
			} else {
				@Pc(97) int local97 = Static1.aClass2_Sub3_Sub1_5.method1743(2);
				if (local97 == 0) {
					Static1.anIntArray326[Static1.anInt1800++] = local68;
					local72.anInt2274 = Static1.anInt2511;
					...
					if (local97 == 1) {
						Static1.anIntArray326[Static1.anInt1800++] = local68;
						local72.anInt2274 = Static1.anInt2511;
						local139 = Static1.aClass2_Sub3_Sub1_5.method1743(3);
						local72.method1547(local139, false);
						local149 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
						if (local149 == 1) {
							Static1.anIntArray504[Static1.anInt1190++] = local68;
						}
					} else if (local97 == 2) {
						...
						local149 = Static1.aClass2_Sub3_Sub1_5.method1743(3);
						local72.method1547(local149, true);
						@Pc(203) int local203 = Static1.aClass2_Sub3_Sub1_5.method1743(1);
						if (local203 == 1) {
							Static1.anIntArray504[Static1.anInt1190++] = local68;
						}
					} else if (local97 == 3) {
