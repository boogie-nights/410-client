...
public final class BZip2 {
    ...
    public static int method1265(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
        @Pc(1) BZip2State local1 = state;
        synchronized (state) {
            state.aByteArray23 = arg2;
            state.anInt2420 = 9;
            state.aByteArray21 = arg0;
            state.anInt2408 = 0;
            state.anInt2409 = arg1;
            state.anInt2416 = 0;
            state.anInt2403 = 0;
            state.anInt2405 = 0;
            state.anInt2421 = 0;
            method1273(state);
            @Pc(37) int local37 = arg1 - state.anInt2409;
            state.aByteArray23 = null;
            state.aByteArray21 = null;
            return local37;
        }
    }
    ...
    private static void method1273(@OriginalArg(0) BZip2State arg0) {
        ...
        if (BZip2State.tt == null) {
            BZip2State.tt = new int[arg0.anInt2413 * 100000];
        }
                ...
                while (true) {
                    while (local531 != local420) {
                        if (local531 == 0 || local531 == 1) {
                            ...
                            while (local541 > 0) {
                                BZip2State.tt[local470] = local60 & 0xFF;
                                local470++;
                                local541--;
                            }
                        } else {
                            ...
                            BZip2State.tt[local470] = arg0.aByteArray19[local60 & 0xFF] & 0xFF;
                            local470++;
                            if (local501 == 0) {
                                local473++;
                                local501 = 50;
                    ...
                    for (local138 = 0; local138 < local470; local138++) {
                        local60 = (byte) (BZip2State.tt[local138] & 0xFF);
                        BZip2State.tt[arg0.anIntArray523[local60 & 0xFF]] |= local138 << 8;
                        arg0.anIntArray523[local60 & 0xFF]++;
                    }
                    arg0.anInt2411 = BZip2State.tt[arg0.anInt2398] >> 8;
                    arg0.anInt2414 = 0;
                    arg0.anInt2411 = BZip2State.tt[arg0.anInt2411];
