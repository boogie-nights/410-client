...
public final class Static35 {
	...
	public static void method711(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		Static25.method1612(arg1, arg3 + 16, 16, arg0 - 32, Static1.anInt2253);
		Static25.method1612(arg1, local41 + arg3 + 16, 16, local11, Static1.anInt1936);
		Static25.method1611(arg1, arg3 + local41 + 16, local11, Static1.anInt311);
		Static25.method1611(arg1 + 1, local41 + arg3 + 16, local11, Static1.anInt311);
		Static25.method1603(arg1, arg3 + local41 + 16, 16, Static1.anInt311);
		Static25.method1603(arg1, local41 + arg3 + 17, 16, Static1.anInt311);
		Static25.method1611(arg1 + 15, arg3 + 16 + local41, local11, Static1.anInt1519);
		Static25.method1611(arg1 + 14, local41 + arg3 - -17, local11 - 1, Static1.anInt1519);
		Static25.method1603(arg1, arg3 + local41 + local11 + 15, 16, Static1.anInt1519);
		Static25.method1603(arg1 + 1, local11 + local41 + 14 + arg3, 15, Static1.anInt1519);
	}
	...
	public static void method712(@OriginalArg(0) Component arg0) {
		...
		arg0.addKeyListener(Static1.aClass30_1);
		arg0.addFocusListener(Static1.aClass30_1);
	}

	@OriginalMember(owner = "client!hb", name = "c", descriptor = "(B)[Lclient!vb;", line = 324)
	public static Pix24[] method715() {
		@Pc(8) Pix24[] local8 = new Pix24[Static28.anInt727];
	...
	public static void method719() {
		...
		if (Static1.anInt1548 >= 0) {
			if (Static1.anInt432 > 0) {
				Static1.anInt2474 += Static1.anInt1175;
				Static98.aClass12_1.method1244(Static1.anInt2474, Static1.anInt1548);
				Static1.anInt432--;
				if (Static1.anInt432 == 0) {
			...
			if (Static1.anInt432 == 0) {
				...
				if (Static23.aByteArray9 != null) {
					Static1.anInt1548 = Static26.anInt685;
