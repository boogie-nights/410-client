...
public final class SoundTone {
	...
	public void method843(@OriginalArg(0) Packet arg0) {
		this.aClass26_5 = new SoundEnvelope();
			...
			if (arg0 >= local194 + local202) {
				...
				while (local207 < local354) {
					...
					for (local556 = 0; local556 < local207; local556++) {
						local359 -= (int) ((long) anIntArray248[local207 - local556 - 1] * (long) SoundFilter.anIntArrayArray12[1][local556] >> 16);
					}
