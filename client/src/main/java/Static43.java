...
public final class Static43 {
	...
	public static void method1636() {
		@Pc(10) int local10 = Static1.aClass2_Sub3_Sub1_5.gBit(8);
		@Pc(20) int local20;
		...
		for (local20 = 0; local20 < local10; local20++) {
			...
			@Pc(71) int local71 = Static1.aClass2_Sub3_Sub1_5.gBit(1);
			if (local71 == 0) {
				Static1.anIntArray408[Static1.anInt2067++] = local62;
				local66.anInt2274 = Static1.anInt2511;
			} else {
				@Pc(91) int local91 = Static1.aClass2_Sub3_Sub1_5.gBit(2);
				if (local91 == 0) {
					Static1.anIntArray408[Static1.anInt2067++] = local62;
					local66.anInt2274 = Static1.anInt2511;
					...
					if (local91 == 1) {
						Static1.anIntArray408[Static1.anInt2067++] = local62;
						local66.anInt2274 = Static1.anInt2511;
						local138 = Static1.aClass2_Sub3_Sub1_5.gBit(3);
						local66.method1547(local138, false);
						local148 = Static1.aClass2_Sub3_Sub1_5.gBit(1);
						if (local148 == 1) {
							Static1.anIntArray504[Static1.anInt1190++] = local62;
						}
					} else if (local91 == 2) {
						...
						local148 = Static1.aClass2_Sub3_Sub1_5.gBit(3);
						local66.method1547(local148, true);
						@Pc(206) int local206 = Static1.aClass2_Sub3_Sub1_5.gBit(1);
						if (local206 == 1) {
							Static1.anIntArray504[Static1.anInt1190++] = local62;
						}
					} else if (local91 == 3) {
